...
# Rscript tad_matching_signif_across_hicds_allMatch_v2_randommidposstrict.R
# Rscript tad_matching_signif_across_hicds_allMatch_v2_randommidposstrict.R norm_vs_tumor
# Rscript tad_matching_signif_across_hicds_allMatch_v2_randommidposstrict.R subtypes
# Rscript tad_matching_signif_across_hicds_allMatch_v2_randommidposstrict.R wt_vs_mut
