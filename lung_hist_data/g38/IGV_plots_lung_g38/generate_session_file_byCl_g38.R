require(ggsci)
# Rscript ./generate_session_file_byCl_g38.R

files_dt <- read.delim("../metadata_plot_list_38.csv", stringsAsFactors = FALSE, sep=",",
...
data_folder <- "../encode_data_38"

plot_start <- paste0(4820000 - 10000)#"AKR1C_TAD_4837809_5077808
plot_end <- paste0(5150000 + 10000)#"
# True TAD: 


cl_types <- unique(files_dt$origin)
cl_types <- c( "PC-9" ,"A549" , "IMR-90", "lung"  , "left lung"  ,  "lower lobe of left lung" ,"upper lobe of left lung" ,"AG04450" )
...
for(cl in cl_types) {
  ...
  writeLines(
  paste0("snapshotDirectory /media/electron/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/lung_hist_data/g38/IGV_plots_lung_g38/plots\n
  maxPanelHeight 1200\n
