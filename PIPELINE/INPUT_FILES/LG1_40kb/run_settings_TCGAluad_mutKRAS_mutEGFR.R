...
# > file edited: Fri, 23 Aug 2019 09:44:26 +0200 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/LG1_40kb/TCGAluad_mutKRAS_mutEGFR"
