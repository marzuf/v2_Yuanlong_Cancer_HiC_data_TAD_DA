...
# > file edited: Fri, 23 Aug 2019 09:42:45 +0200 

# path to output folder:
pipOutFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105194_cerebellum_40kb/TCGAlgg_IDHwt_IDHmutnc"
