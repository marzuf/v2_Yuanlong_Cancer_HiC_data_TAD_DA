...
# Rscript create_final_table_partial.R
...
script_name <- "create_final_table_partial.R"
...
script19sameNbr_name <- "19sameNbrPartial_SAM_emp_measurement"
...
outFolder <- "CREATE_FINAL_TABLE_PARTIAL" # "CREATE_FINAL_TABLE_10000" for 10000 permut
