...
# Rscript go_signif_geneLevel_tadLevel_intersectDiff_partial.R <tadpval> <genepval>
# Rscript go_signif_geneLevel_tadLevel_intersectDiff_partial.R 0.01 0.05 

hicds="K562_40kb"
exprds="TCGAlaml_wt_mutFLT3"

script_name <- "go_signif_geneLevel_tadLevel_intersectDiff_partial.R"
...
outFolder <- file.path("GO_SIGNIF_GENELEVEL_TADLEVEL_INTERSECTDIFF_PARTIAL", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifThresh))
