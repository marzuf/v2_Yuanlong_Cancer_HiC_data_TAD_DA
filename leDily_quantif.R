...
# )
# foo <- dev.off()
# xvar <- "signifDE_and_DA"
# yvar <- "all_and_DA"
# axlab <- "ratio of genes"
# outFile <- file.path(outFolder, paste0(xvar, "_AND_", yvar, ".png"))
# png(outFile, height=350, width=550)
# plot_density_2_vars(xvar, yvar,all_stats_dt, my_xlab= axlab, legPos = "topright")
# foo <- dev.off()
# 
# outFile <- file.path(outFolder, paste0(xvar, "_AND_", yvar, "_box.png"))
# png(outFile, height=400, width=400)
...
# axlab <- "ratio of activated genes"
# xvar <- "upDE_and_activated"
# outFile <- file.path(outFolder, paste0(xvar, ".png"))
# png(outFile, height=350, width=550)
# plot_multiDens(
...
# xvar <- "concordantDown_and_repressed"
# yvar <- "concordantUp_and_activated"
# axlab <- "ratio of TADs"
# outFile <- file.path(outFolder, paste0(xvar, "_AND_", yvar, ".png"))
# png(outFile, height=350, width=550)
# plot_density_2_vars(xvar, yvar,
#                     all_stats_dt, my_xlab= axlab, legPos = "topright")
# foo <- dev.off()
# outFile <- file.path(outFolder, paste0(xvar, "_AND_", yvar, "_box.png"))
# png(outFile, height=400, width=400)
# plot_boxplot(all_stats_dt[,c("dataset",xvar, yvar)],
