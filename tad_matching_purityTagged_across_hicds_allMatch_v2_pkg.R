...
# Rscript tad_matching_purityTagged_across_hicds_allMatch_v2_pkg.R
...
script_name <- "tad_matching_purityTagged_across_hicds_allMatch_v2_pkg.R"
...
outFolder <- file.path("TAD_MATCHING_PURITYTAGGED_ACROSS_HICDS_ALLMATCH_v2_PKG", data_cmpType, purity_plot_name, transfExpr)
