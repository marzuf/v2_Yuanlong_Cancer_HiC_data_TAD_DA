...
# Rscript tad_matching_enrich_enhancer_annot.R
# Rscript tad_matching_enrich_enhancer_annot.R subtypes
# Rscript tad_matching_enrich_enhancer_annot.R norm_vs_tumor
# Rscript tad_matching_enrich_enhancer_annot.R wt_vs_mut
