...
# Rscript revision_inter_intra_proba_v2_corrected_pairedHiC.R
script_name="revision_inter_intra_proba_v2_corrected_pairedHiC.R"
startTime <- Sys.time()
...
outFolder <- "REVISION_INTER_INTRA_PROBA_V2_CORRECTED_PAIREDHIC"
