script_name <- "go_specificity_geneLevel_tadLevel_intersectDiff_MF.R"
options(scipen=100)
...
# Rscript go_specificity_geneLevel_tadLevel_intersectDiff_MF.R 0.05 0.05
# Rscript go_specificity_geneLevel_tadLevel_intersectDiff_MF.R 0.01 0.05
...
outFolder <- file.path("GO_SPECIFICITY_GENELEVEL_TADLEVEL_INTERSECTDIFF_MF", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifTresh))
...
inFile <- file.path("GO_SIGNIF_GENELEVEL_TADLEVEL_INTERSECTDIFF_MF", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifTresh), "all_go_enrich_list.Rdata")
