...
# Rscript go_signif_geneLevel_tadLevel_intersectDiff_MF.R <tadpval> <genepval>
# Rscript go_signif_geneLevel_tadLevel_intersectDiff_MF.R 0.01 0.05 

hicds="K562_40kb"
exprds="TCGAlaml_wt_mutFLT3"

script_name <- "go_signif_geneLevel_tadLevel_intersectDiff_MF.R"
...
outFolder <- file.path("GO_SIGNIF_GENELEVEL_TADLEVEL_INTERSECTDIFF_MF", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifTresh))
