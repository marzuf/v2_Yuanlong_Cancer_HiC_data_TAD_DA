...
# Rscript go_signif_geneLevel_tadLevel_intersectDiff_H.R <tadpval> <genepval>
# Rscript go_signif_geneLevel_tadLevel_intersectDiff_H.R 0.01 0.05 

hicds="K562_40kb"
exprds="TCGAlaml_wt_mutFLT3"

script_name <- "go_signif_geneLevel_tadLevel_intersectDiff_H.R"
...
} else if(enricher_ontologyType == "H"){
  gmtFile <- file.path("h.all.v7.0.entrez.gmt")
} else {
...
outFolder <- file.path("GO_SIGNIF_GENELEVEL_TADLEVEL_INTERSECTDIFF_H", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifTresh))
