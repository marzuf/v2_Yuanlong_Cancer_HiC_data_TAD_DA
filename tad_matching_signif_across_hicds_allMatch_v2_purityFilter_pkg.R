...
# Rscript tad_matching_signif_across_hicds_allMatch_v2_purityFilter_pkg.R
...
outFolder <- file.path("TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_PURITYFILTER_PKG", data_cmpType, purity_ds,pm, transfExpr)
