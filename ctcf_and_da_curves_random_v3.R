...
# Rscript ctcf_and_da_curves_random_v3.R
...
all_patterns <- c("RANDOMMIDPOS", "RANDOMMIDPOSDISC", "RANDOMMIDPOSSTRICT")
# all_patterns="RANDOMMIDPOSDISC"

for(randompatt in all_patterns) {
  ...
  all_obs_hicds <- all_hicds[grepl(paste0(randompatt, "_40kb"), all_hicds)]
  ...
  inFolder <- file.path("CTCF_AND_DA_ALLDS_RANDOM", randompatt)
  ...
  outFolder <- file.path("CTCF_AND_DA_CURVES_RANDOM_V3", randompatt)
  ...
  inFile <- file.path("CREATE_FINAL_TABLE_RANDOM/all_result_dt.Rdata")
