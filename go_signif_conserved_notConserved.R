...
# Rscript go_signif_conserved_notConserved.R
# Rscript go_signif_conserved_notConserved.R norm_vs_tumor
# Rscript go_signif_conserved_notConserved.R subtypes
# Rscript go_signif_conserved_notConserved.R wt_vs_mut

script_name <- "go_signif_conserved_notConserved.R"
