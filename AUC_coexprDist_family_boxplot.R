startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist_family_boxplot.R\n"))

# Rscript AUC_coexprDist_family_boxplot.R ENCSR079VIJ_G401_40kb TCGAkich_norm_kich
...
outFolder <- file.path("AUC_COEXPRDIST_FAMILY_BOXPLOT", hicds, exprds)
