...
# Rscript revision_inter_intra_proba2_v2_corrected.R
script_name="revision_inter_intra_proba2_v2_corrected.R"
startTime <- Sys.time()
...
outFolder <- "REVISION_INTER_INTRA_PROBA2_V2_CORRECTED"
