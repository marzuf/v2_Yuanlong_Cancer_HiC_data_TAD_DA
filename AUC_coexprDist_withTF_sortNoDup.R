startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist_withTF_sortNoDup.R\n"))


# Rscript AUC_coexprDist_withTF_sortNoDup.R c3.tft ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
...
outFold <- file.path("AUC_COEXPRDIST_WITHTF_SORTNODUP", dsIn,  curr_TADlist, paste0(curr_dataset))
...
tfFile <- file.path("CREATE_TF_SORTNODUP", dsIn, "all_tf_pairs.Rdata")
