...
for(cl in cl_types) {
  ...
  all_files <- file.path(data_folder, paste0(files_dt$data, ".bigWig"))
  ...
  for(i in 1:nrow(files_dt)) {
    ...
    track_path <- file.path(data_folder, paste0(files_dt$data[i], ".bigWig"))
  ...
  writeLines(
  paste0("snapshotDirectory /media/electron/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/lung_hist_data_bw/IGV_plots_lung/plots\n
  maxPanelHeight 1200\n
