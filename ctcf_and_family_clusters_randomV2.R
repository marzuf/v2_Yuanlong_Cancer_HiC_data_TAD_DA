...
# Rscript ctcf_and_family_clusters_randomV2.R
...
outFolder <- file.path("CTCF_AND_FAMILY_CLUSTERS_RANDOMV2", paste0("ctcf", ctcf_clustSize, "_family", family_clustSize))
...
final_fams_cluster_dt$clusterLength <- final_fams_cluster_dt$maxPos - final_fams_cluster_dt$minPos + 1
              ...
              obsAndPermut_closest_clusters_dt <- foreach(i = 1:nrow(final_fams_cluster_dt)) %dopar% {
                ...
                i_sameSize <- which.min(curr_size-all_genes_clust_dt$clusterSize)
