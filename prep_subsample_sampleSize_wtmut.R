# Rscript prep_subsample_sampleSize_wtmut.R
...
x = get(load("/media/electron//mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105381_HepG2_RANDOMSUB1_40kb/TCGAlihc_wt_mutCTNNB1/0_prepGeneData/rna_fpkmDT.Rdata"))
stopifnot(ncol(x) == all_sub_nbr1[1] + all_sub_nbr2[1])

x = get(load("/media/electron//mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105381_HepG2_RANDOMSUB1_40kb/TCGAlihc_wt_mutCTNNB1/1_runGeneDE/DE_rnaseqDT.Rdata"))
stopifnot(ncol(x) == all_sub_nbr1[1] + all_sub_nbr2[1])

x = get(load("/media/electron//mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/GSE105381_HepG2_RANDOMSUB2_40kb/TCGAlihc_wt_mutCTNNB1/0_prepGeneData/rna_fpkmDT.Rdata"))
