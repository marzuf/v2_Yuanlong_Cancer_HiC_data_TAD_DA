...
# Rscript tad_matching_signif_across_hicds_allMatch_v2_shuffle_purityFilter_vSameNbr.R
# Rscript tad_matching_signif_across_hicds_allMatch_v2_shuffle_purityFilter_vSameNbr.R norm_vs_tumor
# Rscript tad_matching_signif_across_hicds_allMatch_v2_shuffle_purityFilter_vSameNbr.R subtypes
# Rscript tad_matching_signif_across_hicds_allMatch_v2_shuffle_purityFilter_vSameNbr.R wt_vs_mut
...
script_name <- "tad_matching_signif_across_hicds_allMatch_v2_shuffle_purityFilter_vSameNbr.R"
...
outFolder <- file.path("TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_SHUFFLE_PURITYFILTER_VSAMENBR", data_cmpType, purity_plot_name, transfExpr)
