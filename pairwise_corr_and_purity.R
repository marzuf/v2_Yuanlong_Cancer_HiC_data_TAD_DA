########################################################################################################################################################################################
startTime <- Sys.time()
cat(paste0("> Rscript pairwise_corr_and_purity.R\n"))

script_name <- "pairwise_corr_and_purity.R"
...
# Rscript pairwise_corr_and_purity.R
# Rscript pairwise_corr_and_purity.R EPIC
...
outFolder <- file.path(paste0("PAIRWISE_CORR_AND_PURITY", file_suffix))
