...
registerDoMC(40)
require(ggpubr)
# Rscript cmp_meanFC_permut_midpos_allDS.R
...
outFolder <- "CMP_MEANFC_PERMUT_MIDPOS_ALLDS"
...
all_ds_meanFC_dt$hicds_lab <- gsub(".+RANDOMMIDPOSDISC_40kb", "RANDOMMIDPOSDISC",
