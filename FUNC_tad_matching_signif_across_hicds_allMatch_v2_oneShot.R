...
# Rscript FUNC_tad_matching_signif_across_hicds_allMatch_v2_oneShot.R  
...
allSignif_dt=signif_dt
save(allSignif_dt, file=file.path(outFolder, "allSignif_dt.RData"))
load(file.path(outFolder, "allSignif_dt.RData"))
...
allSignif_tad_pos_dt=all_tad_pos_dt
save(allSignif_tad_pos_dt, file=file.path(outFolder, "allSignif_tad_pos_dt.RData"))
load(file.path(outFolder, "allSignif_tad_pos_dt.RData"))
...
allSignif_g2t_dt=all_g2t_dt
save(allSignif_g2t_dt, file=file.path(outFolder, "allSignif_g2t_dt.RData"))
load(file.path(outFolder, "allSignif_g2t_dt.RData"))
...
all_signif_matching_dt <- all_signif_matching_dt[order(as.character(all_signif_matching_dt$refID_full), 
													as.character(all_signif_matching_dt$queryID_full), as.numeric(as.character(all_signif_matching_dt$overlapBp)), as.numeric(as.character(all_signif_matching_dt$nOverlapGenes))),]
rownames(all_signif_matching_dt) =NULL
outFile <- file.path(outFolder, paste0("all_signif_matching_dt2.Rdata"))
save(all_signif_matching_dt, file=outFile, version=2)
cat(paste0("... written: ", outFile, "\n"))
