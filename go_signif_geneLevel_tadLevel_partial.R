...
# Rscript go_signif_geneLevel_tadLevel_partial.R

hicds="K562_40kb"
exprds="TCGAlaml_wt_mutFLT3"

script_name <- "go_signif_geneLevel_tadLevel_partial.R"
...
outFolder <- file.path("GO_SIGNIF_GENELEVEL_TADLEVEL_PARTIAL", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifTresh))
