...
# Rscript create_final_table_bothSameNbrDouble.R
...
script11same_name <- "11sameNbrSameNbrDouble_runEmpPvalCombined"
...
outFolder <- "CREATE_FINAL_TABLE_BOTHSAMENBRDOUBLE" # "CREATE_FINAL_TABLE_10000" for 10000 permut
