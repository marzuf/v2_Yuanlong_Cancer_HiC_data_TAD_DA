...
# ./run_pipeline.sh ENCSR489OCU_NCI-H460_RANDOMNBRGENES_40kb TCGAluad_mutKRAS_mutEGFR 
# ./run_pipeline.sh ENCSR489OCU_NCI-H460_RANDOMSHIFT_40kb TCGAluad_mutKRAS_mutEGFR  
