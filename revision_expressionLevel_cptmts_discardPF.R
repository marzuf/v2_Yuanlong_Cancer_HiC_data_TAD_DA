...
# Rscript revision_expressionLevel_cptmts_discardPF.R

outFolder <- file.path("REVISION_EXPRESSIONLEVEL_CPTMTS_DISCARDPF")
...
#########################################################
# filter here !
stopifnot(purity_flagged_tads %in% tad2cptmt_dt$region_ID)
tad2cptmt_dt <- tad2cptmt_dt[! tad2cptmt_dt$region_ID %in% purity_flagged_tads,]
#########################################################
