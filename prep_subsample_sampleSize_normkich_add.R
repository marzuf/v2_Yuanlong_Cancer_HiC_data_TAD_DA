# Rscript prep_subsample_sampleSize_normkich_add.R
...
#			cmd <- paste0("cp -r ENCSR079VIJ_G401_40kb ENCSR079VIJ_G401_RANDOMSUB", iSub,"-", i,"_40kb")
#			cat(paste0("> ", cmd, "\n"))
#			system(cmd)

#			cmd <- paste0("rm -rf ENCSR079VIJ_G401_RANDOMSUB", iSub, "-", i, "_40kb/FINAL_DOMAINS*")
#			cat(paste0("> ", cmd, "\n"))
#			system(cmd)

#			cmd <- paste0("./run_pipeline.sh ENCSR079VIJ_G401_RANDOMSUB", iSub, "-", i, "_40kb TCGAkich_norm_kich")
#			cat(paste0("> ", cmd, "\n"))
#			system(cmd)
...
x = get(load(paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB1_40kb/TCGAkich_norm_kich/1_runGeneDE/DE_rnaseqDT.Rdata")))
stopifnot(ncol(x) == all_sub_nbr1[1] + all_sub_nbr2[1])

x = get(load(paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB2_40kb/TCGAkich_norm_kich/0_prepGeneData/rna_fpkmDT.Rdata")))
stopifnot(ncol(x) == all_sub_nbr1[2] + all_sub_nbr2[2])

x = get(load(paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB2_40kb/TCGAkich_norm_kich/1_runGeneDE/DE_rnaseqDT.Rdata")))
stopifnot(ncol(x) == all_sub_nbr1[2] + all_sub_nbr2[2])

x = get(load(paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB3_40kb/TCGAkich_norm_kich/0_prepGeneData/rna_fpkmDT.Rdata")))
stopifnot(ncol(x) == all_sub_nbr1[3] + all_sub_nbr2[3])

x = get(load(paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB3_40kb/TCGAkich_norm_kich/1_runGeneDE/DE_rnaseqDT.Rdata")))
stopifnot(ncol(x) == all_sub_nbr1[3] + all_sub_nbr2[3])

for(i in 2:5) {
for(iSub in 1:length(all_sub_nbr1)) {
x = get(load(paste0(setDir, "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER/ENCSR079VIJ_G401_RANDOMSUB", iSub,"-", i, "_40kb/TCGAkich_norm_kich/1_runGeneDE/DE_rnaseqDT.Rdata"))))
stopifnot(ncol(x) == all_sub_nbr1[iSub] + all_sub_nbr2[iSub])
