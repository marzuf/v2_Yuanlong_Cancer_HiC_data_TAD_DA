...
# Rscript conserv_signif_obsShuffle_purityFilter_final.R
...
outFolder <- file.path("CONSERV_SIGNIF_OBSSHUFFLE_PURITYFILTER_FINAL", purity_ds, pm, transfExpr)
...
inFolder_perm <- file.path("TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_SHUFFLE_PURITYFILTER_FINAL", purity_ds, pm, transfExpr)
