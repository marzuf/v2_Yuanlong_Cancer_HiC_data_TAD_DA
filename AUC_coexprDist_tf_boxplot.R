startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist_tf_boxplot.R\n"))

# Rscript AUC_coexprDist_tf_boxplot.R c3.tft ENCSR079VIJ_G401_40kb TCGAkich_norm_kich
...
outFolder <- file.path("AUC_COEXPRDIST_WITHTF_BOXPLOT", dsIn, hicds, exprds)
dir.create(outFolder, recursive = TRUE)

inFolder <- file.path("AUC_COEXPRDIST_WITHTF_SORTNODUP", dsIn)
