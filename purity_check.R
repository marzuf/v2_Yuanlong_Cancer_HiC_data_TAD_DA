########################################################################################################################################################################################
startTime <- Sys.time()
cat(paste0("> Rscript purity_check.R\n"))

script_name <- "purity_check.R"
...
# Rscript purity_check.R <gene_symbol>
# Rscript purity_check.R GIMAP4
