startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist_exprTF_boxplot.R\n"))

# Rscript AUC_coexprDist_exprTF_boxplot.R chea3_lung ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
...
outFolder <- file.path("AUC_COEXPRDIST_WITHEXPRTF_BOXPLOT", dsIn, hicds, exprds)
dir.create(outFolder, recursive = TRUE)

inFolder <- file.path("AUC_COEXPRDIST_WITHEXPRTF_SORTNODUP", dsIn)
