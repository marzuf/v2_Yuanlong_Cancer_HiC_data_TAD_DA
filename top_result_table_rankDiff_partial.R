...
# Rscript top_result_table_rankDiff_partial.R
...
script_name <- "top_result_table_rankDiff_partial.R"
...
outFolder <- file.path("TOP_RESULT_TABLE_RANKDIFF_PARTIAL")
...
final_dt <- get(load("CREATE_FINAL_TABLE_PARTIAL/all_result_dt.Rdata"))
...
inFolder <- "RANKDIFF_ACTIVDIFF_PARTIAL"
