# Rscript cmp_nSignif_sampleSize_normkich.R
...
outFolder <- "CMP_NSIGNIF_SAMPLESIZE_NORMKICH"
dir.create(outFolder, recursive = TRUE)

tadSignifThresh <- 0.01
geneSignifThresh <- 0.01

init_hicds <- "ENCSR079VIJ_G401"
...
signif_p <- ggplot(data = plot_dt,aes_string(x="sampLab",y="value", fill = "variable"))+
  ggtitle("# signif. and sample size", subtitle = paste0(init_hicds, " - ", exprds))+
