...
# Rscript go_signif_conserved_notConserved_H.R
# Rscript go_signif_conserved_notConserved_H.R norm_vs_tumor
# Rscript go_signif_conserved_notConserved_H.R subtypes
# Rscript go_signif_conserved_notConserved_H.R wt_vs_mut

script_name <- "go_signif_conserved_notConserved_H.R"
