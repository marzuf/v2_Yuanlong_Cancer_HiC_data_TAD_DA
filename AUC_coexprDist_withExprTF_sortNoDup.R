startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist_withExprTF_sortNoDup.R\n"))


# Rscript AUC_coexprDist_withExprTF_sortNoDup.R chea3_lung ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
# Rscript AUC_coexprDist_withExprTF_sortNoDup.R chea3_lung ENCSR489OCU_NCI-H460_40kb TCGAluad_mutKRAS_mutEGFR
options(scipen=100)
...
outFold <- file.path("AUC_COEXPRDIST_WITHEXPRTF_SORTNODUP", dsIn,  curr_TADlist, paste0(curr_dataset))
