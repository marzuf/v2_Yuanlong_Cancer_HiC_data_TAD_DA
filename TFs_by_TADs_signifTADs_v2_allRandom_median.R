...
# Rscript TFs_by_TADs_signifTADs_v2_allRandom_median.R c3.tft
# Rscript TFs_by_TADs_signifTADs_v2_allRandom_median.R chea3_lung
...
for(random_type in all_random_patterns) {
  ...
  outFolder <- file.path(paste0("TFS_BY_TADS_SIGNIFTADS_V2_", random_type, "_MEDIAN_", toupper(dsIn)))
