...
# Rscript familyModules_runMeanTADratioDown.R

script_name <- "familyModules_runMeanTADratioDown.R"
...
outFolder <- file.path("FAMILYMODULES_RUNMEANTADRATIODOWN")
inFolder <- file.path("PREP_FAMILYMODULES")
...
dir.create(dirname(outFile), recursive = TRUE)
save(all_ratioDown, file= outFile)
cat(paste0("... written: ", outFile,  "\n"))
