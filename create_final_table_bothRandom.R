...
# Rscript create_final_table_bothRandom.R
...
script_name <- "create_final_table_bothRandom.R"
...
script11same_name <- "11random_runEmpPvalCombined"
...
outFolder <- "CREATE_FINAL_TABLE_BOTHRANDOM" # "CREATE_FINAL_TABLE_10000" for 10000 permut
