...
# Rscript create_final_table_bothSameNbr_random.R
...
script_name <- "create_final_table_bothSameNbr_random.R"
...
outFolder <- "CREATE_FINAL_TABLE_BOTHSAMENBR_RANDOM" # "CREATE_FINAL_TABLE_10000" for 10000 permut
