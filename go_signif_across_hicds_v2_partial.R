...
# Rscript go_signif_across_hicds_v2_partial.R
# Rscript go_signif_across_hicds_v2_partial.R norm_vs_tumor
# Rscript go_signif_across_hicds_v2_partial.R subtypes
# Rscript go_signif_across_hicds_v2_partial.R wt_vs_mut

script_name <- "go_signif_across_hicds_v2_partial.R"
...
outFolder <- file.path("GO_SIGNIF_ACROSS_HICDS_V2_PARTIAL", data_cmpType)
...
inFolder <- file.path("TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_PARTIAL", data_cmpType)
