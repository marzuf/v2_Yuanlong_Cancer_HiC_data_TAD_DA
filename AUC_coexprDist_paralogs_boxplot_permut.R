startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist_paralogs_boxplot_permut.R\n"))

# Rscript AUC_coexprDist_paralogs_boxplot_permut.R ENCSR079VIJ_G401_40kb TCGAkich_norm_kich
# Rscript AUC_coexprDist_paralogs_boxplot_permut.R ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
...
outFolder <- file.path("AUC_COEXPRDIST_PARALOGS_BOXPLOT_PERMUT", hicds, exprds)
dir.create(outFolder, recursive = TRUE)

inFolder <- file.path("AUC_COEXPRDIST_WITHPARALOGS_SORTNODUP_PERMUT")
