...
# ./all_boxplot_coexprDist_paralogs.sh

start_time=$(date -R)   

scriptCoexpr="AUC_coexprDist_paralogs_boxplot.R"
...
# Rscript AUC_coexprDist_paralogs_boxplot.R ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
