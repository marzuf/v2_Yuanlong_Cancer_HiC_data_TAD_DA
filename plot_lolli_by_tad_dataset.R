...
script_name <- "plot_lolli_by_tad_dataset.R"
...
outFolder <- file.path("PLOT_LOLLI_BY_TAD_DATASET")
...
outFile <- file.path(outFolder, paste0(hicds, "_", exprds, "_", gene_tad, "_all_ds_signif_TADs_lolli.", plotType))

mytit <- paste0("All signif. TADs containing ", gene_tad, " (", nDS, "/", nTotDS, "; ", nExprds, "/", nTotExprds, ")")
