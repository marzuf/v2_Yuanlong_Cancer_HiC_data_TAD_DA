...
# Rscript plot_lolli_by_symbol.R <gene_symbol>
# Rscript plot_lolli_by_symbol.R IFIT3
# Rscript plot_lolli_by_symbol.R JMJD8
# Rscript plot_lolli_by_symbol.R MT1L
# Rscript plot_lolli_by_symbol.R MAPK7
# Rscript plot_lolli_by_symbol.R FCGR2C
# Rscript plot_lolli_by_symbol.R NUP93
# Rscript plot_lolli_by_symbol.R SORD
# Rscript plot_lolli_by_symbol.R SLAMF7
# Rscript plot_lolli_by_symbol.R LILRA2
# Rscript plot_lolli_by_symbol.R ACTL10
# Rscript plot_lolli_by_symbol.R RRP12
# Rscript plot_lolli_by_symbol.R BRICD5
# Rscript plot_lolli_by_symbol.R GSTM4
# Rscript plot_lolli_by_symbol.R PGAM1
# Rscript plot_lolli_by_symbol.R RHBDL1
# Rscript plot_lolli_by_symbol.R FBXL16
...
script_name <- "plot_lolli_by_symbol.R"
...
outFolder <- file.path("PLOT_LOLLI_BY_SYMBOL")
...
ds=all_datasets[1]
ds=all_datasets[2]
# return a value if present in the dataset + if signif
...
outFile <- file.path(outFolder, paste0(gene_symbol, "_", gene_entrez, "_all_ds_signif_TADs_lolli.", plotType))
...
for(cmp in unique(all_cmps)) {
  ...
  outFile <- file.path(outFolder, paste0(gene_symbol, "_", gene_entrez, "_", cmp, "_signif_TADs_lolli.", plotType))
