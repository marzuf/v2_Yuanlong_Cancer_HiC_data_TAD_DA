...
# Rscript conserv_signif_obsShuffle_purityFilter_vSameNbr_final.R
...
outFolder <- file.path("CONSERV_SIGNIF_OBSSHUFFLE_PURITYFILTER_VSAMENBR_FINAL", purity_ds, pm, transfExpr)
...
inFolder_perm <- file.path("TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_SHUFFLE_PURITYFILTER_VSAMENBR_FINAL", purity_ds,pm, transfExpr)
inFolder_obs <- file.path("TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_PURITYFILTER_FINAL", purity_ds, pm,transfExpr)
