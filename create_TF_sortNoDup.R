...
cat(paste0("> Rscript create_TF_sortNoDup.R\n"))
...
# Rscript create_TF_sortNoDup.R c3.tft
# Rscript create_TF_sortNoDup.R chea3_lung
...
outFold <- file.path("CREATE_TF_SORTNODUP", dsIn)
...
by(reg_dt, reg_dt$regSymbol, function(x) {
...
outFile <- file.path(outFold, paste0("all_tf_pairs.Rdata"))
