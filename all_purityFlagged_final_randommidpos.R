...
# _randommidpos > for the RANDOMMIDPOS

SSHFS=F

# Rscript all_purityFlagged_final_randommidpos.R
...
script_name <- "all_purityFlagged_final_randommidpos.R"
...
outFolder <- file.path("ALL_PURITYFLAGGED_FINAL_RANDOMMIDPOS", purity_ds, pm, transfExpr)
dir.create(outFolder, recursive = TRUE)

purity_file <- file.path("ALLTADS_AND_PURITY_FINAL_RANDOMMIDPOS", purity_ds, pm, transfExpr, "all_ds_corrPurity_dt.Rdata") # here _final INPUT and _randommidpos
...
result_file <- file.path("CREATE_FINAL_TABLE_RANDOM", "all_result_dt.Rdata") # here the random
