...
# Rscript create_final_table_permut.R
...
script_name <- "create_final_table_permut.R"
...
outFolder <- "CREATE_FINAL_TABLE_PERMUT" # "CREATE_FINAL_TABLE_10000" for 10000 permut
...
if(length(args) == 0) {
  ...
  all_hicds <- all_hicds[grepl("_PERMUTG2T", all_hicds) ]
