...
# ./all_coexprDist_paralogs.sh

start_time=$(date -R)   

scriptCoexpr="AUC_coexprDist_withParalogs_sortNoDup.R"
...
# Rscript AUC_coexprDist_withParalogs_sortNoDup.R ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
