...
# Rscript trial_viper.R

outFolder <- file.path("TRIAL_VIPER")
...
luad_nullmodel <- ttestNull(x = cond2_exprDT, y = cond1_exprDT, per = 1000, repos = T, verbose = F)
