startTime <- Sys.time()
cat(paste0("> Rscript reportfig2_figure4_partial.R\n"))

# Rscript reportfig2_figure4_partial.R 0.01 0.05
...
outFolder <- file.path("REPORTFIG2_FIGURE4_PARTIAL")
...
inFile <- file.path("GO_SIGNIF_GENELEVEL_TADLEVEL_INTERSECTDIFF_PARTIAL", paste0("tadPvalThresh", TAD_pvalThresh, "_genePvalThresh", gene_pvalThresh), "all_go_enrich_list.Rdata")
