script_name <- "go_specificity_geneLevel_tadLevel_intersectDiff_report.R"
options(scipen=100)
...
outFolder <- file.path("GO_SPECIFICITY_GENELEVEL_TADLEVEL_INTERSECTDIFF_REPORT", paste0("tadPvalThresh", tads_signifThresh, "_genePvalThresh", genes_signifThresh))
